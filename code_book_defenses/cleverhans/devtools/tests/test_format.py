...
import cleverhans_src
from cleverhans_src.devtools.tests.docscrape import docstring_errors
from cleverhans_src.devtools.list_files import list_files
...
whitelist_pep8.extend([os.path.relpath(path, cleverhans_src.__path__[0])
...
def test_format_pep8():
    ...
    for path in list_files(".py"):
        rel_path = os.path.relpath(path, cleverhans_src.__path__[0])
