...
class FMNISTDATASET(ImagesDataSet):
...
class FMNISTDataProvider(DataProvider):
    ...
    def __init__(self, shuffle=None, validation_set=None, validation_split=None,
        ...
        self.test = FMNISTDATASET(images=X_test, labels=y_test, shuffle=None,
